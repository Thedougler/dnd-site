...
| Major Places | [[Keth-Naar]], [[Vel-Orn]], [[Ral-Arn]], [[Dath-Mar]], [[Meth-Var]] |
| Controlled By | Keth-Naar elders, watch rotations, and shrine authority |
| Access | Maw crossing, open water, dangerous reefs, and local knowledge required |
| Known For | A vast Blue Hole, Tabaxi watch culture, failing sea blessing, and dragon turtle nesting secrets |

## Geography

The Blue Hole occupies the majority of the Sunken Crown. From any high point on the islands it reads as a near-perfect dark circle inside the reef rim. It is deep enough that soundings fail quickly, warm in places from lingering volcanic activity, and clear enough near the edges that large shadows can be seen moving far below. The boundary between the turquoise shallows and the indigo drop is clean and sudden.
...
| Place | Type | Notes |
|---|---|---|
| [[Keth-Naar\|Keth-Naar]] | town / island | Main settlement; Tabaxi hunting community, black basalt promontories, tide pools, and the clearest outsider contact. |
| [[Vel-Orn\|Vel-Orn]] | shrine island | Shrine island at the Blue Hole's centre; barren, difficult to approach, kept outside ordinary travel. |
| [[Ral-Arn\|Ral-Arn]] | record island | Where the oldest family histories and seasonal marks are kept in stone. |
| [[Dath-Mar\|Dath-Mar]] | refuge island | Maintained for emergencies, shelter, and solitary retreat. |
| [[Meth-Var\|Meth-Var]] | watch island | Faces open Maw waters and is staffed by rotating watchers rather than permanent inhabitants. |

## Settlements & Sites

| Place | Type | Notes |
|---|---|---|
| [[Keth-Naar\|Keth-Naar]] | town | Primary settlement and source of local guides, watch knowledge, and Stripes' home context. |
| [[Umberlee-Shrine\|Umberlee Shrine]] | shrine | Shrine authority tied to the failing blessing, debt marks, and the drowned. |
| The Blue Hole | landmark / hazard | Vast central drop-off that shapes weather, food security, watch rotations, and dragon turtle rumours. |
| Dath-Mar outer beaches | nesting site | Protected generational dragon turtle nesting beaches known to elders. |
| Meth-Var outer beaches | nesting site | Protected generational dragon turtle nesting beaches known to elders. |

## Routes & Access

Getting here requires crossing east of the [[Drowned-Maw|Drowned Maw]] into the [[Outer-Reach|Outer Reach]] — six hours over the Maw, then open water. The five islands are surrounded by reefs and channels that do not behave consistently. A ship without local knowledge risks reef damage or being drawn toward the Blue Hole's drop-off.

## People & Power

The Tabaxi of Keth-Naar organize the region through elders, watch rotations, seasonal knowledge, refuge practice, and shrine obligations. Without the Pearl of Souls, the shrine still marks debts and remembers the drowned, but its deepest function — stabilizing the Blue Hole and protecting nesting waters — is failing.

## Trade & Resources

The Sunken Crown is not a broad trade region. It survives through local hunting, tide-pool knowledge, watch discipline, shrine authority, emergency refuges, and careful management of dangerous shorelines. Food security and weather protection are degrading because Umberlee's blessing has failed since the Pearl of Souls was stolen.

## Flora

The land surface of the Sunken Crown is lean: salt grass, wind-bent scrub, and black stone that absorbs heat and releases it through the night.
...
- [[places/sunken-crown/index|Sunken Crown Index]]
