...
| Major Places | [[Veth]], [[Sorn]], [[Karath]], [[Dreth]], [[Orak]] |
| Controlled By | [[Grung-Clans\|The Grung Clans]] |
| Access | Sanctioned contact at Veth's west beach; interiors forbidden |
| Known For | Strict trade protocols, poisonous boundaries, rainforest hazards, and worsening raids |

## Geography

The Teeth are five reef-fringed islands with low coasts, limestone ridges, shallow inter-island channels, flooded cuts, drowned root water, and dense rainforest interiors. The narrow channels between Dreth and Orak, and between Karath and Sorn, are shallow enough that some interior animals cross them more easily than a chart suggests. The islands' ridges, drainages, trade beaches, and agricultural clearings form one managed interior system rather than five isolated wildernesses.

## Major Locations

| Place | Type | Notes |
|---|---|---|
| [[Veth]] | island | Largest island and only sanctioned trade face of the cluster. |
| [[Sorn]] | island | Known for interior agriculture and guarded beach traffic. |
| [[Karath]] | island | Reef gaps are met with dart fire before questions; sailors give it the widest berth. |
| [[Dreth]] | island | Eastern, lower, wetter, and quieter island; not safe. |
| [[Orak]] | island | Eastern, lower, wetter, and quieter island; linked by shallow crossings. |

## Settlements & Sites

| Place | Type | Notes |
|---|---|---|
| Veth west beach | trade beach | Only sanctioned outsider contact point; traders anchor offshore and wait. |
| Grung interior paths | wilderness routes | Paths avoid certain ridges, drainages, spider-webbed canopy gaps, and giant ape ranges. |
| Karath reef gaps | reef approaches | Dangerous approaches where boats are met with dart fire. |
| Sorn agricultural clearings | interior sites | Agriculture positioned around grung patrol needs and high-ridge animal ranges. |
...
The [[Grung-Clans|Grung clans]] control the region in practice and in force. Outsiders encounter blue-caste intermediaries at the beach, never the interior authority structure directly. The trade protocols are boundary markers as much as etiquette: who speaks, who touches, who waits offshore, and who stays out of the trees.
...
The Teeth's interiors are dense rainforest, flooded channels, root water, agricultural clearings, plant-pigment sources, resin-producing growth, and poison-crafting plant material. Specific flora is otherwise not yet documented.
...
The largest animal stories stay mostly inland. Some traders have heard the canopy break in a line too heavy for monkeys or stormfall, and Sorn-bound intermediaries sometimes arrive with fresh splinter wounds on shields that look more like thrown stone than claw. If [[beastiary/beasts/giant-ape|giant apes]] live in the Teeth, they are not beach curiosities. They are high-ridge animals moving between fruiting canopy, freshwater, and limestone overlooks across more than one island. The grung do not seem to manage them so much as account for them: interior paths that circumvent certain ridges, agriculture positioned away from certain drainages, patrol timing that avoids the hours around dawn on the high ground. None of this is explained to beach traders. It is simply the shape of how the Teeth are used. ^\[inferred]

## Hazards

The Teeth's dangers are social, toxic, and ecological at once: forbidden interiors, poisonous touch, caste protocol errors, dart fire at Karath reef gaps, flooded cuts, giant frogs, spiders, constrictors, venomous snakes, and giant ape high-ridge ranges.

## Current Hooks

- Raids from the direction of the Teeth have worsened, and the [[Chain-Council|Chain Council]] has heard enough complaints to make Veth's beach trade politically fragile.
- The grung pathing and agriculture imply they are accounting for giant ape ranges rather than controlling them. ^\[inferred]
