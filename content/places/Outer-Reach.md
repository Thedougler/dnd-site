...
Out here, a damaged ship is its own distress signal and its own bait. Crews crossing from the Maw watch for [[Whip-Shark|whip sharks]] first, because those are real enough to leave hull scars, and [[beastiary/sea-life/killer-whale|killer whale]] pods second, because a pod that decides to follow a crippled vessel will follow it for longer than most crews want to test.

Pirates are rarer beyond the Maw because distance eats profit, but the ones who come this far are rarely desperate amateurs. A [[beastiary/humanoid/pirate-captain|pirate captain]] in the Outer Reach is usually hunting something specific: an isolated pilgrim ship, a salvage lead, a ship too compromised to report the attack, or a prize already weakened by the crossing. The [[The-Velvet-Noose|Velvet Noose]] appears in these stories less as a patrolable ship than as a moving boundary. If she is east of the Maw, small vessels start looking for reasons to be somewhere else.

## At a Glance

| Field | Detail |
|---|---|
| Type | Open-ocean region beyond the Maw |
| Parent Region | [[Shattered-Sea\|The Shattered Sea]] |
| Major Places | [[Drowned-Maw\|The Drowned Maw]], [[Sunken-Crown\|The Sunken Crown]], Redwind Isles |
| Controlled By | Ungoverned; no colonial patrols |
| Access | Maw crossing, then four days of open water to the nearest islands |
| Known For | Thin charts, no resupply, whip sharks, serpent stories, and distant island regions |

## Geography

Two regions appear on pilots' notes with any consistency. To the northeast, [[Sunken-Crown|the Sunken Crown]]: five low islands around a deep blue hole, black stone and pale reef, a partially submerged volcanic caldera that old charts show fully above water two centuries ago and still sinking. To the southeast, the Redwind Isles: hot, arid, barely inhabited, named for seasonal dust that blows in from the south and leaves a fine red grit on every surface.

Colonial cartographers labelled the Redwind Isles uninhabited and did not ask what made them that way. The few vessels that have anchored in the Redwind harbours and returned describe a stillness that has intent in it and, in at least one account, a shape moving through overcast above the southern cliffs that was too deliberate for weather. An [[beastiary/dragons/ancient-blue-dragon|ancient blue dragon]] does not need to be seen to own a place. It only needs to have been there long enough. ^\[inferred]

## Major Locations

| Place | Type | Notes |
|---|---|---|
| [[Drowned-Maw\|The Drowned Maw]] | trench / crossing | Required western crossing before the Reach opens. |
| [[Sunken-Crown\|The Sunken Crown]] | reef-region | Five low islands around a Blue Hole northeast of the Maw crossing. |
| Redwind Isles | island region | Hot, arid, barely inhabited southeastern islands with abandoned charted settlements and ancient blue dragon signs. |

## Settlements & Sites

| Place | Type | Notes |
|---|---|---|
| Redwind harbours | abandoned harbours | Old charted settlements vanished from the record within a generation of each other. |
| Cold lanes | fishing grounds / route | Longliner waters east of the Maw where large predators move along upwelling. |
| [[Keth-Naar\|Keth-Naar]] | town | Sunken Crown settlement and clearest documented Outer Reach community. |

## Routes & Access

Getting to the Reach means crossing the [[Drowned-Maw|Drowned Maw]] under star navigation, then committing to open water with no resupply. Longliners from [[Tail|the Tail]] work the cold lanes east of the Maw because the fish run rich there at night, and because a full hold can pay for a month of bad weather. The risk is that the same upwelling that brings fish also gives larger predators a road back toward the shelf.

## People & Power

Neither the Sunken Crown nor the Redwind Isles is administered by colonial authority. Both have reasons to exist on someone's manifest — isolation, refuge, pilgrimage, profit — depending on who paid for the voyage. The normal systems of the Scatter stop following here.

## Trade & Resources

The Outer Reach supports longline fishing, isolated pilgrim or refuge travel, salvage rumours, and voyages whose value depends on distance. There are no regular resupply points between the Maw crossing and the nearest islands.

## Flora

Outer Reach flora is not broadly documented. The Sunken Crown is black stone, salt grass, and wind-bent scrub; the Redwind Isles are hot and arid with seasonal red dust.
...
Outer Reach hazards include no resupply, thin charts, Maw crossing fatigue, damaged ships becoming bait, whip sharks, killer whale pursuit, ancient sea serpent stories, dragon turtles, kraken rumours, rare but disciplined piracy, and the ancient blue dragon implication around the Redwind Isles.
...
- The Redwind Isles have uninhabited charted settlements, returned-vessel accounts of intentional stillness, and signs consistent with an ancient blue dragon owning the place. ^\[inferred]
