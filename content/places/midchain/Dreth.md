...
The Dreth-Orak channel holds the island's most documented hazard. [[beastiary/beasts/giant-crocodile|Giant crocodiles]] use the flat, shadowed, slow-moving water between the islands as ambush ground — still enough to read as safe, deep enough to conceal a body of that size until it commits. The supply skiff incident is the most-cited account, but pilots who work the eastern Teeth regularly treat the channel as a route to be planned around rather than through.

[[beastiary/beasts/giant-constrictor-snake|Giant constrictor snakes]] use the flooded channel margins as cover — root shadow, low-hanging canopy, water that runs too shallow for a vessel but deep enough for a large body to move through without breaking the surface. The Grung path system around the eastern swamp avoids certain pools and clears others, which is the clearest evidence that the local population maps the snake territory without advertising the map.
